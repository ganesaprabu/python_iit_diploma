...
# Passing the list of values to a function and we can iterate through that the list given through parameter which is passed to the method through parameter
